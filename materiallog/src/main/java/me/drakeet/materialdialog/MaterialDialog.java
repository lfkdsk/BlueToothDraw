...
public class MaterialDialog {
    ...
    public MaterialDialog setNatureButton(String text, final View.OnClickListener listener) {
        mNatureButton = new Button(mContext);
        mLayoutParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
        );
        mNatureButton.setLayoutParams(mLayoutParams);
        mNatureButton.setBackgroundResource(R.drawable.button);
        mNatureButton.setText(text);
        mNatureButton.setTextColor(Color.argb(222, 0, 0, 0));
        mNatureButton.setTextSize(14);
        mNatureButton.setGravity(Gravity.CENTER);
        mNatureButton.setOnClickListener(listener);
        if (isLollipop()) {
            mNatureButton.setBackgroundResource(android.R.color.transparent);
        }
        return this;
    }
...
//7
            ...
            if(mLayoutParams != null && mNatureButton != null){
                if (mButtonLayout.getChildCount() > 0) {
                    mLayoutParams.setMargins(dip2px(12), 0, 0, dip2px(BUTTON_BOTTOM));
                    mNatureButton.setLayoutParams(mLayoutParams);
                    mButtonLayout.addView(mNatureButton,0);
                } else {
                    mNatureButton.setLayoutParams(mLayoutParams);
                    mButtonLayout.addView(mNatureButton);
                }
            }

...
import com.lfk.bluetoothc.PaintView.OnPathListener;
import com.lfk.bluetoothc.PaintView.PaintView;
import com.lfk.bluetoothc.PaintView.PathNode;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.discoverable:
                ...
                return true;
            case R.id.input:
                View view = View.inflate(this,R.layout.input_item,null);
                final EditText editText = (EditText)view.findViewById(R.id.edit_input);
                Button button = (Button)view.findViewById(R.id.input_button);
